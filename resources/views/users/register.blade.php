                    ...
                    <div class="card card-glass px-3 py-2">
                        <div class="card-body text-white">
                            <div class="py-1">
                                ...
                                <div class="toggle-container-button mb-3">
                                    <button type="button" id="btnCustomer" class="toggle-btn active">Customer</button>
                                    <button type="button" id="btnPhotographer" class="toggle-btn">Photographer</button>
                                </div>
                            </div>
                            <div class="customer">
                                <form id="customerForm" method="POST" action="{{ url('register') }}"
                                    ...
                                    <input type="text" class="form-control input-glass text-white py-2" id="role"
                                        name="role" value="3" required hidden>
                            ...
                            <div class="photographer">
                                <form id="photographerForm" method="POST" action="{{ url('register/photographer') }}"
                                    class="text-white text-start">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="name" class="form-label"><b>Full Name</b></label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="location" placeholder="Jakarta" name="location"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control input-glass text-white py-2"
                                            id="role" value="2" name="role" required hidden>
                                        <input type="text" class="form-control input-glass text-white py-2"
                                            id="status" value="1" name="status" required hidden>
                                    </div>
                                    <div class="d-grid gap-2">
                                        <button class="btn btn-primary-sm">Register</button>
                                    </div>
