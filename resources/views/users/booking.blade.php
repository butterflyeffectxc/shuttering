...
@section('content')
    <div class="booking-bg text-white">
        <div class="container page-content">
            ...
            <div class="container">
                <div class="row booking-container mt-5 justify-content-center">
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                        <div class="booking-card">
                            <div class="booking-card-header">
                                <img src="https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e" alt="Cecilia Bright"
                                    class="booking-card-photo" />
