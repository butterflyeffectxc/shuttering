        ...
        <div class="row g-0 align-items-center d-flex">
            ...
            <div class="col-12 col-md-6">
                <div class="text-center ">
                    <h2>Capture moments, <br> Frame your story with us.</h2>
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <p><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                                    fill="none">
                                    <path
                                        ...
                                        fill="#FAFAFA" />
                                </svg> +62 896 8270 336</p>
                        </div>
                        <div class="col-12 col-md-6"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none">
                                <mask id="mask0_689_1258" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                    width="24" height="24">
                                    <rect width="24" height="24" fill="#D9D9D9" />
                                </mask>
                                <g mask="url(#mask0_689_1258)">
                                    <path
                            ...
                            </svg> hello.shuttering@gmail.com</div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-3">
