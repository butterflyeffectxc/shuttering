            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.html"><img src="{{ asset('assets/assets/compiled/svg/favicon.svg') }}"
                                    alt="Logo" srcset=""></a>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4 col-12">
                                            <button id="basic"
                                                class="btn btn-outline-primary btn-lg btn-block">Basic
                                                Example</button>
                                        </div>
                                        <div class="col-md-4 col-12">
                                            <button id="title" class="btn btn-outline-primary btn-lg btn-block">A
                                                title with a text</button>
                                        </div>
                                        <div class="col-md-4 col-12">
                                            <button id="footer"
                                                class="btn btn-outline-primary btn-lg btn-block">With
                                                Footer</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted">SweetAlert can also show a message in the corner of your
                                        screen!</p>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <button id="toast-failed"
                                                class="btn btn-outline-primary btn-lg btn-block">Failed Toast</button>
                                        </div>
                                        <div class="col-md-4 col-12">
                                            <button id="toast-warning"
                                                class="btn btn-outline-primary btn-lg btn-block">Toast Warning</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
