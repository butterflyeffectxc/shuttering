        ...
        if (/\.(jpe?g|png|gif|mp4|webm|ogg|ogv|mp3|wav)$/i.test(file.name)) {
            if (file.size < 10 * 1024 * 1024) {
                ...
                reader.onloadstart = function (e) {
                    document.querySelector("#progressand").style.display =
                        "block";
                ...
                reader.onprogress = function (e) {
                    if (e.lengthComputable) {
                        ...
                        if (percentLoaded < 99) {
                            document.querySelector("#dynamic").style.width =
                                percentLoaded + "%";
                ...
                reader.addEventListener("error", function () {
                    return iziError(
                        failed,
                        "Error occurred reading file: ${file.name}"
                    );
                });
                reader.addEventListener(
                    ...
                    function () {
                        ...
                        if (/\.(jpe?g|png|gif|)$/i.test(file.name)) {
                            ...
                            image.setAttribute(
                                "onclick",
                                'this.classList.toggle("Imgpreview-zoom");'
                            );
            ...
            return iziToast.error({
                title: "failed",
                message:
                    "Please provide avalid file. Accepted formats include .mp4, mp3, .png, .jpg, and .gif.",
                iconText: "error_outline",
            });
        }
    }
                                    ...
                                    _createClass(MDEmoji, [
                                        ...
                                        },
                                        {
                                            ...
                                            value: function (emojiInput) {
                                                ...
                                                emojiTrigger.classList.add(
                                                    "emojiTrigger"
                                                ),
                                                    emojiTrigger.setAttribute(
                                                        "href",
                                                        "javascript:void(0)"
                                                    ),
                                                    emojiTrigger.setAttribute(
                                                ...
                                                emojiCategories.map(function (
                                                    ...
                                                    [
                                                        ...
                                                        129315, 128515, 128516,
                                                        128517, 128518, 128521,
                                                        128522, 128526, 128525,
                                                        128536, 128535, 128537,
                                                        128538, 9786, 128578,
                                                        129303, 129300, 128528,
                                                        128529, 128566, 128580,
                                                        128527, 128547, 128549,
                                                        128558, 129296, 128559,
                                                        128554, 128555, 128564,
                                                        128524, 129299, 128539,
                                                        128540, 128541, 129316,
                                                        128530, 128531, 128532,
                                                        128533, 128579, 129297,
                                                        128562, 9785, 128577,
                                                        128534, 128542, 128543,
                                                        128548, 128546, 128557,
                                                        128550, 128551, 128552,
                                                        128553, 128556, 128560,
                                                        128561, 128563, 128565,
                                                        128545, 128544, 128519,
                                                        129312, 129313, 129317,
                                                        128567, 129298, 129301,
                                                        129314, 129319, 128520,
                                                        128127, 128121, 128122,
                                                        128128, 9760, 128123,
                                                        128125, 128126, 129302,
                                                        128169, 128570, 128568,
                                                        128569, 128571, 128572,
                                                        128573, 128576, 128575,
                                                        128574, 128584, 128585,
                                                        128586, 128102, 128103,
                                                        128104, 128105, 128116,
                                                        128117, 128118, 128124,
                                                        128110, 128373, 128130,
                                                        128119, 128115, 128113,
                                                        127877, 129334, 128120,
                                                        129332, 128112, 129333,
                                                        129328, 128114, 128589,
                                                        128590, 128581, 128582,
                                                        128129, 128587, 128583,
                                                        129318, 129335, 128134,
                                                        128135, 128694, 127939,
                                                        128131, 128378, 128111,
                                                        128372, 128483, 128100,
                                                        128101, 128107, 128108,
                                                        128109, 128143, 128106,
                                                        128170, 129331, 128072,
                                                        128073, 9757, 128070,
                                                        128405, 128071, 9996,
                                                        129310, 128406, 129304,
                                                        129305, 128400, 9995,
                                                        128076, 128077, 128078,
                                                        9994, 128074, 129307,
                                                        129308, 129306, 128075,
                                                        128079, 9997, 128080,
                                                        128588, 128591, 129309,
                                                        128133, 128066, 128067,
                                                        128099, 128064, 128065,
                                                        128069, 128068, 128139,
                                                        10084, 128147, 128152,
                                                        128148, 128149, 128150,
                                                        128151, 128153, 128154,
                                                        128155, 128156, 128420,
                                                        128157, 128158, 128159,
                                                        10083, 128140, 128164,
                                                        128162, 128163, 128165,
                                                        128166, 128168, 128171,
                                                        128172, 128488, 128495,
                                                        128173, 128371, 128083,
                                                        128374, 128085, 128084,
                                                        128086, 128087, 128088,
                                                        128089, 128090, 128091,
                                                        128092, 128093, 128717,
                                                        127890, 128094, 128095,
                                                        128096, 128097, 128098,
                                                        128081, 128082, 127913,
                                                        127891, 9937, 128255,
                                                    ...
                                                    [
                                                        ...
                                                        127819, 127820, 127821,
                                                        127822, 127823, 127824,
                                                        127825, 127826, 127827,
                                                        129373, 127813, 127846,
                                                        127847, 127848, 127849,
                                                        127850, 127874, 127856,
                                                        127851, 127852, 127853,
                                                        127854, 127855, 127868,
                                                        129371, 9749, 127861,
                                                        127862, 127870, 127863,
                                                        127864, 127865, 127866,
                                                        127867, 129346, 129347,
                                                        129361, 127814, 129364,
                                                        129365, 127805, 127798,
                                                        129362, 127812, 129372,
                                                        127792, 127838, 129360,
                                                        129366, 129374, 129472,
                                                        127830, 127831, 129363,
                                                        127828, 127839, 127829,
                                                        127789, 127790, 127791,
                                                        129369, 129370, 127859,
                                                        129368, 127858, 129367,
                                                        127871, 127857, 127832,
                                                        127833, 127834, 127835,
                                                        127836, 127837, 127840,
                                                        127842, 127843, 127844,
                                                        127845, 127841, 127869,
                                                        127860, 129348, 128298,
                                                        127994,
                                                    ].map(function (item) {
                                                        var emojiLink =
                                                            document.createElement(
                                                    ...
                                                    [
                                                        9917, 9918, 127936,
                                                        127952, 127944, 127945,
                                                        127934, 127921, 127923,
                                                        127951, 127953, 127954,
                                                        127955, 127992, 129354,
                                                        129355, 129349, 127919,
                                                        9971, 9976, 127907,
                                                        127933, 127935, 127942,
                                                        129353, 129352, 129351,
                                                        127941, 127894, 129338,
                                                        127943, 9975, 127938,
                                                        127948, 127940, 128675,
                                                        127946, 9977, 127947,
                                                        128692, 128693, 129336,
                                                        129340, 129341, 129342,
                                                        129337, 127918, 128377,
                                                        127922, 9824, 9829,
                                                        9830, 9827, 127183,
                                                        126980, 127924,
                                                    ].map(function (item) {
